            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, rgba(233, 30, 99, 0.4) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style="border-radius: 53px">
                    <div class="grid flex flex-column align-items-center">
                        ...
                        <h1 class="text-900 font-bold text-5xl mb-2">Completa los Campos</h1>
                        <span class="text-600 mb-5">Incumpliste en no completas los campos</span>
                        <img src="/demo/images/error/asset-error.svg" alt="Error" class="mb-5" width="80%" />
                        <div class="col-12 mt-5 text-center">
                            <i class="pi pi-fw pi-arrow-left text-blue-500 mr-2" style="vertical-align: center"></i>
                            <router-link to="/auth/login" class="text-blue-500">Volver al Login</router-link>
                        </div>
                    </div>
                </div>
            </div>

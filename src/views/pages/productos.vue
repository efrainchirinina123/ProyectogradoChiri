...
<template>
            ...
            <div class="card surface-card shadow-2 border-round p-4">
                ...
                >
                    ...
                    <Column field="precio" header="Precio" :sortable="true">
                        <template #body="{ data }">
                            <InputNumber v-model="data.precio" mode="currency" currency="BOB" :disabled="true" />
                        </template>
                    </Column>
    ...
    <Dialog header="Detalles del Producto" :visible="productDialog" :modal="true" @clik="hideDialog" class="product-dialog">
        <div class="dialog-content">
            ...
            <div class="field image-upload">
                ...
                <div class="image-preview-container" v-if="imageUrl">
                    ...
                    <button class="delete-icon" @click="hideDialog">×</button>
                </div>
            ...
            <div class="field">
                ...
                <InputNumber v-model="product.precio" mode="currency" currency="BOB" required class="input-number" />
            </div>
    ...
    <ConfirmDialog :visible="deleteProductDialog" @clik="deleteProductDialog=false" message="¿Estás seguro de eliminar este producto?"
...
.custom-upload-button {
    background-color: #145e83; /* Primary color for the button */
    color: white;

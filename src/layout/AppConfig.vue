    ...
    <Sidebar v-model:visible="visible" position="right" class="layout-config-sidebar w-26rem" pt:closeButton="ml-auto">
        <div class="p-2">
            <section class="pb-4 flex align-items-center justify-content-between border-bottom-1 surface-border">
                <span class="text-xl font-semibold">Zoom</span>
            ...
            <section class="py-4 flex align-items-center justify-content-between border-bottom-1 surface-border">
                <span class="text-xl font-semibold">Efecto</span>
            ...
            <section class="py-4 border-bottom-1 surface-border">
                ...
                <span class="font-medium">Color I</span>
                ...
                <div class="flex align-items-center justify-content-between gap-3 mb-3">
                    ...
                    >
                        <span class="block h-1rem w-full" style="border-radius: 30px; background: linear-gradient(180deg,#ffc319 0%, rgba(236, 72, 153, 0.5) 100%)"></span>
                    </button>
                </div>
            ...
            <section class="py-4 border-bottom-1 surface-border">
                <div class="flex align-items-center gap-2 mb-3">
                    ...
                    <span class="font-medium">Color II</span>
                </div>
                <div class="flex align-items-center justify-content-between gap-3 mb-3">
                    <button
                        :class="[
            ...
            <section class="py-4 border-bottom-1 surface-border">
                <div class="flex align-items-center gap-2 mb-3">
                    <img src="https://primefaces.org/cdn/primevue/images/themes/md-light-indigo.svg" alt="Diseño" class="border-circle" style="width: 1.5rem" />
                    <span class="font-medium">Diseño</span>
                    <div class="ml-auto flex align-items-center gap-2">
                        <label for="material-condensed" class="text-sm"></label>
